...
INITIAL_VIEW_STATE = pdk.ViewState(latitude=40.7128, longitude=74.0060, zoom=11, max_zoom=16, pitch=45, bearing=0)
...
if select == 'Pedestrians':
    st.write(data.query("injured_pedestrians >= 1")[["on_street_name", "injured_pedestrians"]].sort_values(by=['injured_pedestrians']).dropna(how="any")[:5])
